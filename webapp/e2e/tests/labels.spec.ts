...
test.describe('Label Filtering — Mobile', () => {
  ...
  test('clicking a label chip on a note card filters to that label', async ({ page, dashboardPage, isMobile }) => {
    test.skip(isMobile, 'Note card label chips are not interactive on mobile.');
    await dashboardPage.goto();
  ...
  test('clicking a note card label chip does not open the note', async ({ page, dashboardPage, isMobile }) => {
    test.skip(isMobile, 'Note card label chips are not interactive on mobile.');
    await dashboardPage.goto();
