  ...
  describe('Notes API', () => {
    ...
    describe('sharing functionality', () => {
      it('shares note with user', async () => {
        const shareData: ShareNoteRequest = { user_id: 'user2' }
      ...
      it('unshares note', async () => {
        const unshareData: ShareNoteRequest = { user_id: 'user2' }
      ...
      it('handles sharing errors', async () => {
        ...
        const shareData: ShareNoteRequest = { user_id: 'nonexistentuserid00000' }
