    ...
    >
      ...
      */}
      ...
      <Menu>
        ...
        <MenuItems onKeyDownCapture={handleMenuKeyDown} className="absolute right-0 mt-1 w-52 origin-top-right bg-white dark:bg-slate-800 rounded-md shadow-lg ring-1 ring-black/5 dark:ring-slate-600/20 focus:outline-none z-10 border border-gray-200 dark:border-slate-600 transition duration-100 ease-out starting:scale-95 starting:opacity-0 motion-reduce:transition-none">
          <div className="py-1">
            {inBin ? (
              <>
                {onRestore && (
