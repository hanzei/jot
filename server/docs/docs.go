...
const docTemplate = `{
    ...
    "paths": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.DeleteUserNotesResponse"
                        }
                    },
                    "400": {
                        "description": "bad request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.SetUserPasswordRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/oidc/callback": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "web: redirect to the app, or on failure to /login or /settings with ?sso_error=\u003ccode\u003e; native: redirect to jot://oidc-callback with a code or error"
                    }
                }
            }
        },
        ...
        "/auth/oidc/native/exchange": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "one-time code and its PKCE verifier",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.NativeExchangeRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "type": "string",
                        "description": "what the resulting code may be redeemed for",
                        "name": "intent",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "BASE64URL(SHA256(code_verifier)), unpadded (S256)",
                        "name": "code_challenge",
                        "in": "query",
                        "required": true
                    }
        ...
        "/notes/import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Import format: jot_json or google_keep (requires file); usememos (requires url and token)",
                        "name": "import_type",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "file",
                        "description": "Export file (required when import_type is jot_json or google_keep)",
                        "name": "file",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Memos instance URL (required when import_type is usememos)",
                        "name": "url",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Memos API token (required when import_type is usememos)",
                        "name": "token",
                        "in": "formData"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateNoteItemRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ReorderNoteItemsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.PatchNoteItemRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.CreateNoteItemRequest": {
            "type": "object",
            "properties": {
                "assigned_to": {
                    "type": "string"
        ...
        "handlers.NativeExchangeRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "handlers.ReorderNoteItemsRequest": {
            "type": "object",
            "properties": {
                "item_ids": {
                    "type": "array",
