...
task check-mobile    # Lint + test the mobile app, plus the Expo SDK version check (check-shared likewise)
...
task check-mobile-expo  # Check mobile's Expo-governed deps match SDK 57's expected versions
