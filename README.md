...
- **PWA Quick Capture**: Installed webapp PWAs get the same long-press icon shortcuts ("New note", "New list") and appear in the OS share sheet, both landing directly in a ready-to-type new note via the bookmarkable `/new` route
